...
export default function LevelUpOverlay({ level, visible, onDismiss }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="mx-4 bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-900 rounded-3xl p-8 text-center max-w-xs w-full shadow-2xl animate-scale-in"
        ...
        >
          ...
          <div className="text-purple-200 text-xl font-bold mb-4">{lvl.name}</div>
          ...
          <button
            onClick={onDismiss}
            className="w-full bg-gradient-to-r from-amber-400 to-orange-400 text-white font-bold py-3 rounded-2xl text-sm hover:opacity-90 transition-opacity"
          >
            Keep Learning →
          </button>
        </div>
