    ...
    <div className="min-h-screen" style={{ background: '#F8F7F4' }}>
      ...
      <div className="hidden lg:flex h-screen overflow-hidden">
        ...
        <div className="flex-1 flex flex-col h-screen overflow-hidden">
          <header className="flex-shrink-0 h-14 bg-white/80 backdrop-blur-sm px-6 flex items-center justify-between" style={{ borderBottom: '0.5px solid #E5E7EB' }}>
            <div>
      ...
      <div className="hidden sm:flex lg:hidden h-screen overflow-hidden">
        <aside className="w-14 flex-shrink-0 bg-white flex flex-col h-screen items-center py-4" style={{ borderRight: '0.5px solid #E5E7EB' }}>
      ...
      <div className="sm:hidden">
        <Outlet />
        <div className="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-xl flex justify-around items-center px-1 pt-1 pb-5 z-30" style={{ borderTop: '0.5px solid #E5E7EB' }}>
          {MOBILE_TABS.map(tab => {
